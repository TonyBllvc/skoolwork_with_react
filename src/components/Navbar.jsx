...
const Navbar = () => {
    return(
        <nav className="bg w-full h-full flex flex-col overflow-hidden overscroll-none">
            <div className=' pl-2'>
                <div className="">
                ...
                <div>
                    <NavLink to="/" className=' flex items-center justify-start  font-bold text-sm w-4/5 pl-6 py-3 my-3 rounded-l-3xl hover:bg-yellow-200 active:bg-yellow-200 hover:text-black active:text-black text-white hover:shadow-lg hover:shadow-slate-800'>
                        <AiOutlineHome className=' text-2xl text-white font-semibold active:text-black pr-2' />
                         <p className='text-white active:text-black hover:text-black h-full '>Dashboard</p> </NavLink>
